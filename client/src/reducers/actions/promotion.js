...
export const promoteAndMove = ({ newPosition, newMove, castleDirection, gameStatus = 'ongoing', lastMove }) => {
    return {
        type: actionTypes.PROMOTION_MOVE,
        payload: { newPosition, newMove, castleDirection, gameStatus, lastMove }
    }
};